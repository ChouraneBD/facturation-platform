...
const defaultCategories = [
  { nom: 'Informatique', taux_tva: 20.0 },
  { nom: 'Services', taux_tva: 10.0 },
  { nom: 'Formation', taux_tva: 0.0 },
  { nom: 'Fournitures', taux_tva: 20.0 }
];
...
const createCategory = async (req, res) => {
  try {
    ...
    const category = await Category.create({ nom, taux_tva: taux_tva ?? 20.0 });
